...
"}")
        icon = QIcon()
        icon.addFile(u"icons/24x24/cil-menu.png", QSize(), QIcon.Normal, QIcon.On)
...
"")
        icon1 = QIcon()
        icon1.addFile(u"icons/24x24/cil-home.png", QSize(), QIcon.Normal, QIcon.On)
...
"")
        icon2 = QIcon()
        icon2.addFile(u"icons/24x24/cil-library-add.png", QSize(), QIcon.Normal, QIcon.On)
...
"")
        icon3 = QIcon()
        icon3.addFile(u"icons/24x24/cil-chart-line.png", QSize(), QIcon.Normal, QIcon.On)
...
"")
        icon4 = QIcon()
        icon4.addFile(u"icons/24x24/cil-folder-open.png", QSize(), QIcon.Normal, QIcon.On)
...
"")
        icon5 = QIcon()
        icon5.addFile(u"icons/24x24/cil-settings.png", QSize(), QIcon.Normal, QIcon.On)
...
"border-radius: 20px;")
        ...
        self.label_6.setPixmap(QPixmap(u"icons/add.png"))
...
"")
        self.label_7.setPixmap(QPixmap(u"icons/remove.png"))
...
"	border: 2px solid rgb(43, 50, 61);\n"
"}")
        self.toolButton_delete.setIcon(icon7)
...
"}")
        icon8 = QIcon()
        icon8.addFile(u"icons/24x24/cil-description.png", QSize(), QIcon.Normal, QIcon.On)
